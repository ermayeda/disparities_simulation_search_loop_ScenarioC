...
*Target values
global target_p_death0to1_exp0 = 
global target_p_death1to5_exp0 = 
global target_p_death5to10_exp0 = 
global target_p_death10to15_exp0 = 
global target_p_death15to20_exp0 = 
global target_p_death20to25_exp0 = 
global target_p_death25to30_exp0 = 
global target_p_death30to35_exp0 = 
global target_p_death35to40_exp0 = 
global target_p_death40to45_exp0 = 
global target_p_death45to50_exp0 = 
global target_p_death50to55_exp0 = 
global target_p_death55to60_exp0 = 
global target_p_death60to65_exp0 = 
global target_p_death65to70_exp0 = 
global target_p_death70to75_exp0 = 
global target_p_death75to80_exp0 = 
global target_p_death80to85_exp0 = 
global target_p_death85to90_exp0 = 
global target_p_death90to95_exp0 = 
*global target_p_death95to100_exp0 = 

*Starting values
global lambda_0to1l = 
global lambda_1to5l = 
global lambda_5to10l = 
global lambda_10to15l = 
global lambda_15to20l = 
global lambda_20to25l = 
global lambda_25to30l = 
global lambda_30to35l = 
global lambda_35to40l = 
global lambda_40to45l = 
global lambda_45to50l = 
global lambda_50to55l = 
global lambda_55to60l = 
global lambda_60to65l = 
global lambda_65to70l = 
global lambda_70to75l = 
global lambda_75to80l = 
global lambda_80to85l = 
global lambda_85to90l = 
global lambda_90to95l = 
*global lambda_95to100l = 
...
*Starting values
global stk_lambda_exp0_45to50l = 
global stk_lambda_exp0_50to55l = 
global stk_lambda_exp0_55to60l = 
global stk_lambda_exp0_60to65l = 
global stk_lambda_exp0_65to70l = 
global stk_lambda_exp0_70to75l = 
global stk_lambda_exp0_75to80l = 
global stk_lambda_exp0_80to85l = 
global stk_lambda_exp0_85to90l = 
global stk_lambda_exp0_90to95l = 
...
forvalues i=1/5 {
   ...
   *add lower bound guess here
   local lambda_90to95l = 0.2	//0.3074
   quietly forvalues x = 0(.01)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   ...
   *add lower bound guess here
   local lambda_95to100l = 0.22	//0.4678
   quietly forvalues x = 0(.01)30 { //0(.0001)30 {
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_0to1 = 0.30
   *add lower bound guess here
   local g1_0to1l = 0.1 //0.30
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_1to5 = 0.37
   *add lower bound guess here
   local g1_1to5l = 0.1 //0.37
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_5to10 = 0.23
   *add lower bound guess here
   local g1_5to10l = 0 //0.23
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_10to15 = 0.56
   *add lower bound guess here
   local g1_10to15l = 0.1 //0.56
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_15to20 = 0.94
   *add lower bound guess here
   local g1_15to20l = 0.4 //0.94
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_20to25 = 0.92
   *add lower bound guess here
   local g1_20to25l = 0.4 //0.92
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_25to30 = 0.79
   *add lower bound guess here
   local g1_25to30l = 0.3 //0.79
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_30to35 = 0.78
   *add lower bound guess here
   local g1_30to35l = 0.3 //0.78
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_35to40 = 0.77
   *add lower bound guess here
   local g1_35to40l = 0.3 //0.77
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
...
forvalues i=1/5 {
   clear
   local toolow =1
   local target_g1_40to45 = 0.74
   *add lower bound guess here
   local g1_40to45l = 0.3 //0.74
   quietly forvalues x = 0(.01)30 { 
      if `toolow'==1 {
         local seed = 8675309 + `i'
		 set seed `seed'
